...
//Portada
$pdf->AddPage();
$pdf->Image('../img/doc/encabezado_2.jpg', 0 , 0 , 210, 24);
$pdf->Image('../img/doc/pie_2.jpg', 0 , 273 , 210, 24);
...
$pdf->SetY( $Y_Pagina_1 + 32);
$pdf->Cell($anchoPagina,10,'P R E S E N T E','0', '0', 'L');



//Contenido
$pdf->SetY( $Y_Pagina_1 + 47);
$pdf->SetFont('Arial','',12);
$pdf->Cell($anchoPagina,10,'     A. ANÁLISIS DE MERCADO OBJETIVO','0', '0', 'L');

$pdf->SetY( $Y_Pagina_1 + 60);
$pdf->MultiCell($anchoPagina,6, "En cumplimiento a lo dispuesto en el contrato celebrado entre Afore XXI Banorte y SOLUCIONES PROFESIONALES MAGNIF S. DE R.L. DE C.V., en el que se acuerda prestar los servicios de “Análisis de Mercado y Trámites relacionados con la Prospectación de Nueva Afiliación”, a través de este documento realizamos la entrega correspondiente al servicio prestado por SOLUCIONES PROFESIONALES MAGNIF.\n 
...
foreach($voJSON->DatosJSON as $JSON){
    ...
    if( file_exists( '../img_claveunica/'.utf8_decode($JSON->cve_unica).'.jpg' ) ){
        ...
        $pdf->Image( '../img_claveunica/100000000.jpg', 20 , 120 , 170, 120);
    }
    ...
    if( file_exists( '../html_claveunica/'.utf8_decode($JSON->cve_unica).'.html' ) ){
        ...
        $pdf->Cell(160, 5, "Dar click aquí",'0', '0', 'C', true, "http://www.solucionafore.com/html_claveunica/100000000.html");
    }
