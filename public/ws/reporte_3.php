...
//Portada
$pdf->AddPage();
$pdf->Image('../img/doc/encabezado_3.jpg', 0 , 0 , 210, 24);
$pdf->Image('../img/doc/pie_3.jpg', 0 , 276 , 210, 21);
$pdf->Image('../img/doc/firma_2.png', 90 , 230 , 30, 24);
...
$pdf->Cell($anchoPagina,6,'SOLUCIONES PROFESIONALES MAGNIF, S. de R.L. de C.V.','0', '0', 'R');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'TAMAULIPAS 141 PISO 3-B COL. CONDESA','0', '0', 'R');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'ALCALDIA CUAHTEMOC CIUDAD DE MEXICO 06140','0', '0', 'R');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'Tel.: 55475 05440 557811 2277','0', '0', 'R');
$pdf->Ln();
$pdf->SetFont('Arial','U',12);
$pdf->Cell($anchoPagina,6,'ventasmagnif@gmail.com','0', '0', 'R');
$pdf->Ln(3);

$pdf->Ln();
$pdf->Ln();
$pdf->SetFont('Arial','',12);
$pdf->Cell($anchoPagina,6,'AFORE XXI BANORTE','0', '0', 'L');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'DIRECCIÓN DE ASESORÍA PREVISIONAL','0', '0', 'L');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'AVENIDA PASEO DE LA REFORMA No. EXTERIOR: 489 No. INTERIOR: PISO 3','0', '0', 'L');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'COLONIA: CUAUHTEMOC ALCALDIA: CUAUHTEMOC','0', '0', 'L');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'ESTADO: CIUDAD DE MEXICO C.P. 06500','0', '0', 'L');

//Contenido
$pdf->SetY( $Y_Pagina_1 + 110);
$pdf->SetFont('Arial','',12);
$pdf->MultiCell($anchoPagina,7, "A través de la presente yo, Luz Maria Moreno Ruiz, Representante Legal de Soluciones Profesionales Magnif, S. de R.L. de C.V., hago entrega oficial junto a esta carta de los servicios consistentes en Servicios de Análisis de Mercado y Tramites relacionados con la prospectación de la nueva afiliación, En cumplimiento a lo dispuesto en el contrato celebrado con número de referencia C-320-2023.\n 
...
$pdf->Ln();
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'Luz Maria Moreno Ruiz','0', '0', 'C');
$pdf->Ln();
$pdf->Cell($anchoPagina,6,'Representante Legal','0', '0', 'C');
