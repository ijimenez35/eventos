              ...
              <div class="row g-0">
                <div class="col-lg-6" style="background-color:#FFFFFF">
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <div class="text-center">
                      ...
                      <h4 class="mt-1 mb-5 pb-1">Registro al evento, por favor ingresa tu correo electrónico</h4>
                    </div>
                    ...
                    <form @submit.prevent="registroUsuario($event, $data)" v-show="mailVerificado == true || 1==1" >
                    ...
                    <form @submit.prevent="registroEvento($event, $data)" v-show="mailVerificado == true || 1==1" >
                      <p>Registro Evento</p>
                      ...
                      <div class="text-center pt-1 mb-5 pb-1">
                        <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">Registrarme al evento</button>
                      </div>
                    </form>
                ...
                <div class="col-lg-6 d-flex align-items-center gradient-custom-2" style="background-color:#0090CC">
                  <div class="text-white px-3 py-4 p-md-5 mx-md-4" >
                    <h4 class="mb-4">Reunion Anual Puebla</h4>
